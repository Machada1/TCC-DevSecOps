...
| Checkov | IaC Scan | 0 | ⚠️ Não disponível |

**Total de issues de segurança identificados: 1579**

## 1. 📦 Container Scan - Trivy

**Imagem analisada:** `dvwa-app:fbce037`
...
⚠️ Relatório do Checkov não disponível.
...
*Relatório gerado automaticamente em 12/12/2025 às 16:53:04*